<template>
    <div class="fixed top-0 flex flex-col items-center w-16 h-full overflow-hidden text-gray-400 bg-gray-900">
        ...
        <div class="flex flex-col items-center mt-3 border-t border-gray-700">
            <div
              class="flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-700 hover:text-gray-300 cursor-pointer">
            ...
            <div class="flex items-center justify-center w-12 h-12 mt-2 text-gray-200 bg-gray-700 rounded">
                <svg class="w-6 h-6 stroke-current" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                  stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="flex flex-col items-center mt-2 border-t border-gray-700">
            ...
            <div class="relative flex items-center justify-center w-12 h-12 mt-2 rounded hover:bg-gray-700
