<template>
    <button :class="computedClass">
        <template v-if="props.providerName === 'Google'">
            <img src="/public/google-logo.svg" alt="Google Logo" class="w-7 aspect-square" @click="handleOnClick" />
        </template>
        <template v-else-if="props.providerName === 'Facebook'">
            <img src="/public/facebook-logo.svg" alt="Google Logo" class="w-7 aspect-square" @click="handleOnClick" />
        </template>
        <template v-else-if="props.providerName === 'Github'">
            <img src="/public/github-logo.svg" alt="Google Logo" class="w-7 aspect-square" @click="handleOnClick" />
        </template>
